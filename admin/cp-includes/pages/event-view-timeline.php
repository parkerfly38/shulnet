...
<p class="highlight">Click any timeline entry to edit it.</p>
...
<div id="slider_top_table">
    ...
    <div class="floatleft">
        ...
        <input type="button" value="New" class="save"
               onclick="return popup('timeline-add','event=<?php echo $_POST['id']; ?>');"/>
...
<div class="pad24">
    ...
    <ul id="timeline_ul" class="colfields">

        <?php

        foreach ($data['timeline'] as $entry) {
            echo $admin->timeline_entry($entry);

...
$history = new history('', $criteria, '1', '50', 'expires', 'ASC', $table);
...
<form action="cp-includes/get_table.php" id="slider_sorting" method="post"
    ...
    <div id="slider_top_table">
        ...
        <div class="floatleft">
            ...
            <input type="button" value="Add Access" class="save"
                   onclick="return popup('content-access-add','id=&user_id=<?php echo $data['data']['id']; ?>');"/>

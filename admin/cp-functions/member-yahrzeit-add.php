<?php
    ...
    $englishdate = $jd->JewishToGregorian(explode(" ",$newyahrzeit["Hebrew_Date_of_Death"])[0], explode(" ",$newyahrzeit["Hebrew_Date_of_Death"])[1]);
    $return                = array();
    ...
    $return['append_table_row'] .= "<td id=\"".$newyahrzeit["id"]."-English_Date_of_Death\">".$englishdate."</td>";

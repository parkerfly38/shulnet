 ...
 * @link        http://www.covebrookcode.com/
 * @copyright   (c) 2013-2016 Castlamp, (c) 2019 Brian Kresge
...
$history = new yahrzeits('', $criteria, '1', '50', 'English_Date_of_Death', 'DESC', $table);
...
<form action="cp-includes/get_table.php" id="slider_sorting" method="post"
    ...
    <input type="hidden" name="order" value="English_Date_of_Death"/>

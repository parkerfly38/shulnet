    ...
    <div id="slider_top_table">
        ...
        <div class="floatleft">
            <input type="button" value="New" class="save"
                   onclick="return popup('note-add','user_id=<?php echo $id; ?>&scope=<?php echo $scope; ?>','1');"/>
        </div>
        <div class="clear"></div>
    </div>
</form>
...
<div id="bottom_delete">
    <div class="pad16">
        ...
        <div class="float_right">Value Total: <?php echo $history->table_cells['math']; ?></div>

        <span class="small gray caps bold" style="margin-right:24px;">With Selected:</span><input type="button"
                                                                                                  value="Delete"
                                                                                                  class="del"
                                                                                                  onclick="return compile_delete('<?php echo $table; ?>','slider_checks');"/>

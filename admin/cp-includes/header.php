...
<head>
    ...
    <meta name="author" content="Cove Brook Code (http://www.covebrookcode.com/)"/>
    ...
    <link type="text/css" rel="stylesheet" media="all" href="css/jquery.accent-keyboard.css"/>
    ...
    <script type="text/javascript" src="js/jquery.accent-keyboard.js"></script>
...
<div id="topbar">
    <div class="holder small">
        ...
        <span class="head">
            ...
            <a href="index.php?l=yahrzeits.php"
        </span>-->
        </div>

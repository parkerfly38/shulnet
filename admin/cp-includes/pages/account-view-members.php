...
$history = new history('', $criteria, '1', '50', 'ppSD_members.username', 'DESC', $table, 'ppSD_member_data', $scope_overrides);
    ...
    <div id="slider_top_table">
        ...
        <div class="floatleft">
            <input type="button" value="New" class="save"
                   onclick="return popup('member-add','account=<?php echo $_POST['id']; ?>','','1');"/>
            <input type="button" value="E-Mail Members" class=""
                   onclick="return get_slider_subpage('email','','type=member');"/>
        </div>
        <div class="clear"></div>
    </div>

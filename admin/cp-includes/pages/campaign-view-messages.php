...
if ($check != '1') {
    ...
    if ($data['when_type'] != 'after_join') {
        $history = new history('', $criteria, '1', '50', 'when_date', 'ASC', $table);

    } else {
        $history = new history('', $criteria, '1', '50', 'when_timeframe', 'ASC', $table);
        ...
        <div id="slider_top_table">
            ...
            <div class="floatleft">
                ...
                <input type="button" value="New" class="save"
                       onclick="return popup('campaign_message-add','campaign_id=<?php echo $data['id']; ?>','1');"/>

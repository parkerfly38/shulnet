...
// and if it exists.
$permission = 'campaign_unsubscribe-view';
...
if ($check != '1') {
    ...
    $history  = new history('', $criteria, '1', '50', 'date', 'ASC', $table);
        ...
        <div id="slider_top_table">
            ...
            <div class="floatleft">
                ...
                <input type="button" value="New" class="save"
                       onclick="return popup('campaign_unsubscribe-add','campaign_id=<?php echo $data['id']; ?>','');"/>

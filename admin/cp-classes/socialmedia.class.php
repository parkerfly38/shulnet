    ...
    */
    ...
    function format_tweet($entry, $user_id = '', $user_type = '')
    {
        if (! empty($entry->created_at)) {
            ...
            return 'Could not retrieve Tweets. Please confirm that you have set up your <a href="http://documentation.covebrookcode.com/FAQ/How-do-I-integrate-Twitter-with-ShulNET%253F" target="_blank">Twitter integration</a> properly.';
        }
    }
